...
func (this *ICommModule) NewEmptyPartitions_(ctx context.Context, n int64) (_err error) { return nil }

func (this *ICommModule) NewEmptyPartitions2_(ctx context.Context, n int64, src *rpc.ISource) (_err error) {
	return nil
}
...
func (this *ICommModule) EnableMultithreading(ctx context.Context, group string) (_r int32, _err error) {
	return 0, nil
}

func (this *ICommModule) Send(ctx context.Context, group string, partition int64, dest int64, thread int32) (_err error) {
	return nil
}

func (this *ICommModule) Recv(ctx context.Context, group string, partition int64, source int64, thread int32) (_err error) {
	return nil
}
