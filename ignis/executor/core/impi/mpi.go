...
MPI_Datatype GO_MPI_2DOUBLE_PRECISION = MPI_2DOUBLE_PRECISION;
MPI_Datatype GO_MPI_2INT = MPI_2INT;
MPI_Datatype GO_MPI_2INTEGER = MPI_2INTEGER;
MPI_Datatype GO_MPI_2REAL = MPI_2REAL;
MPI_Datatype GO_MPI_AINT = MPI_AINT;
char GO_MPI_AINT_FMT_DEC_SPEC[4] = MPI_AINT_FMT_DEC_SPEC;
char GO_MPI_AINT_FMT_HEX_SPEC[4] = MPI_AINT_FMT_HEX_SPEC;
int GO_MPI_ANY_SOURCE = MPI_ANY_SOURCE;
int GO_MPI_ANY_TAG = MPI_ANY_TAG;
int GO_MPI_APPNUM = MPI_APPNUM;
char*** GO_MPI_ARGVS_NULL = MPI_ARGVS_NULL;
char** GO_MPI_ARGV_NULL = MPI_ARGV_NULL;
MPI_Op GO_MPI_BAND = MPI_BAND;
MPI_Op GO_MPI_BOR = MPI_BOR;
void* GO_MPI_BOTTOM = MPI_BOTTOM;
int GO_MPI_BSEND_OVERHEAD = MPI_BSEND_OVERHEAD;
MPI_Op GO_MPI_BXOR = MPI_BXOR;
MPI_Datatype GO_MPI_BYTE = MPI_BYTE;
MPI_Datatype GO_MPI_CHAR = MPI_CHAR;
MPI_Datatype GO_MPI_CHARACTER = MPI_CHARACTER;
MPI_Comm_copy_attr_function * GO_MPI_COMM_DUP_FN = MPI_COMM_DUP_FN;
MPI_Comm GO_MPI_COMM_NULL = MPI_COMM_NULL;
MPI_Comm_copy_attr_function* GO_MPI_COMM_NULL_COPY_FN = MPI_COMM_NULL_COPY_FN;
MPI_Comm_delete_attr_function* GO_MPI_COMM_NULL_DELETE_FN = MPI_COMM_NULL_DELETE_FN;
MPI_Comm GO_MPI_COMM_SELF = MPI_COMM_SELF;
int GO_MPI_COMM_TYPE_SHARED = MPI_COMM_TYPE_SHARED;
MPI_Comm GO_MPI_COMM_WORLD = MPI_COMM_WORLD;
MPI_Datatype GO_MPI_COMPLEX = MPI_COMPLEX;
MPI_Datatype GO_MPI_COMPLEX16 = MPI_COMPLEX16;
MPI_Datatype GO_MPI_COMPLEX32 = MPI_COMPLEX32;
MPI_Datatype GO_MPI_COMPLEX8 = MPI_COMPLEX8;
int GO_MPI_CONGRUENT = MPI_CONGRUENT;
MPI_Datarep_conversion_function * GO_MPI_CONVERSION_FN_NULL = MPI_CONVERSION_FN_NULL;
MPI_Datatype GO_MPI_COUNT = MPI_COUNT;
MPI_Datatype GO_MPI_CXX_BOOL = MPI_CXX_BOOL;
MPI_Datatype GO_MPI_CXX_DOUBLE_COMPLEX = MPI_CXX_DOUBLE_COMPLEX;
MPI_Datatype GO_MPI_CXX_FLOAT_COMPLEX = MPI_CXX_FLOAT_COMPLEX;
MPI_Datatype GO_MPI_CXX_LONG_DOUBLE_COMPLEX = MPI_CXX_LONG_DOUBLE_COMPLEX;
MPI_Datatype GO_MPI_C_BOOL = MPI_C_BOOL;
int GO_MPI_C_COMPLEX = MPI_C_COMPLEX;
MPI_Datatype GO_MPI_C_DOUBLE_COMPLEX = MPI_C_DOUBLE_COMPLEX;
MPI_Datatype GO_MPI_C_FLOAT_COMPLEX = MPI_C_FLOAT_COMPLEX;
MPI_Datatype GO_MPI_C_LONG_DOUBLE_COMPLEX = MPI_C_LONG_DOUBLE_COMPLEX;
MPI_Datatype GO_MPI_DATATYPE_NULL = MPI_DATATYPE_NULL;
int GO_MPI_DISPLACEMENT_CURRENT = MPI_DISPLACEMENT_CURRENT;
int GO_MPI_DISTRIBUTE_BLOCK = MPI_DISTRIBUTE_BLOCK;
int GO_MPI_DISTRIBUTE_CYCLIC = MPI_DISTRIBUTE_CYCLIC;
int GO_MPI_DISTRIBUTE_DFLT_DARG = MPI_DISTRIBUTE_DFLT_DARG;
int GO_MPI_DISTRIBUTE_NONE = MPI_DISTRIBUTE_NONE;
MPI_Datatype GO_MPI_DOUBLE = MPI_DOUBLE;
MPI_Datatype GO_MPI_DOUBLE_COMPLEX = MPI_DOUBLE_COMPLEX;
MPI_Datatype GO_MPI_DOUBLE_INT = MPI_DOUBLE_INT;
MPI_Datatype GO_MPI_DOUBLE_PRECISION = MPI_DOUBLE_PRECISION;
int (*GO_MPI_DUP_FN)(int, int, void*, void*, void*, int*) = MPI_DUP_FN;
int* GO_MPI_ERRCODES_IGNORE = MPI_ERRCODES_IGNORE;
MPI_Errhandler GO_MPI_ERRHANDLER_NULL = MPI_ERRHANDLER_NULL;
MPI_Errhandler GO_MPI_ERRORS_ARE_FATAL = MPI_ERRORS_ARE_FATAL;
MPI_Errhandler GO_MPI_ERRORS_RETURN = MPI_ERRORS_RETURN;
int GO_MPI_ERR_ACCESS = MPI_ERR_ACCESS;
int GO_MPI_ERR_AMODE = MPI_ERR_AMODE;
int GO_MPI_ERR_ARG = MPI_ERR_ARG;
int GO_MPI_ERR_ASSERT = MPI_ERR_ASSERT;
int GO_MPI_ERR_BAD_FILE = MPI_ERR_BAD_FILE;
int GO_MPI_ERR_BASE = MPI_ERR_BASE;
int GO_MPI_ERR_BUFFER = MPI_ERR_BUFFER;
int GO_MPI_ERR_COMM = MPI_ERR_COMM;
int GO_MPI_ERR_CONVERSION = MPI_ERR_CONVERSION;
int GO_MPI_ERR_COUNT = MPI_ERR_COUNT;
int GO_MPI_ERR_DIMS = MPI_ERR_DIMS;
int GO_MPI_ERR_DISP = MPI_ERR_DISP;
int GO_MPI_ERR_DUP_DATAREP = MPI_ERR_DUP_DATAREP;
int GO_MPI_ERR_FILE = MPI_ERR_FILE;
int GO_MPI_ERR_FILE_EXISTS = MPI_ERR_FILE_EXISTS;
int GO_MPI_ERR_FILE_IN_USE = MPI_ERR_FILE_IN_USE;
int GO_MPI_ERR_GROUP = MPI_ERR_GROUP;
int GO_MPI_ERR_INFO = MPI_ERR_INFO;
int GO_MPI_ERR_INFO_KEY = MPI_ERR_INFO_KEY;
int GO_MPI_ERR_INFO_NOKEY = MPI_ERR_INFO_NOKEY;
int GO_MPI_ERR_INFO_VALUE = MPI_ERR_INFO_VALUE;
int GO_MPI_ERR_INTERN = MPI_ERR_INTERN;
int GO_MPI_ERR_IN_STATUS = MPI_ERR_IN_STATUS;
int GO_MPI_ERR_IO = MPI_ERR_IO;
int GO_MPI_ERR_KEYVAL = MPI_ERR_KEYVAL;
int GO_MPI_ERR_LASTCODE = MPI_ERR_LASTCODE;
int GO_MPI_ERR_LOCKTYPE = MPI_ERR_LOCKTYPE;
int GO_MPI_ERR_NAME = MPI_ERR_NAME;
int GO_MPI_ERR_NOT_SAME = MPI_ERR_NOT_SAME;
int GO_MPI_ERR_NO_MEM = MPI_ERR_NO_MEM;
int GO_MPI_ERR_NO_SPACE = MPI_ERR_NO_SPACE;
int GO_MPI_ERR_NO_SUCH_FILE = MPI_ERR_NO_SUCH_FILE;
int GO_MPI_ERR_OP = MPI_ERR_OP;
int GO_MPI_ERR_OTHER = MPI_ERR_OTHER;
int GO_MPI_ERR_PENDING = MPI_ERR_PENDING;
int GO_MPI_ERR_PORT = MPI_ERR_PORT;
int GO_MPI_ERR_QUOTA = MPI_ERR_QUOTA;
int GO_MPI_ERR_RANK = MPI_ERR_RANK;
int GO_MPI_ERR_READ_ONLY = MPI_ERR_READ_ONLY;
int GO_MPI_ERR_REQUEST = MPI_ERR_REQUEST;
int GO_MPI_ERR_RMA_ATTACH = MPI_ERR_RMA_ATTACH;
int GO_MPI_ERR_RMA_CONFLICT = MPI_ERR_RMA_CONFLICT;
int GO_MPI_ERR_RMA_FLAVOR = MPI_ERR_RMA_FLAVOR;
int GO_MPI_ERR_RMA_RANGE = MPI_ERR_RMA_RANGE;
int GO_MPI_ERR_RMA_SHARED = MPI_ERR_RMA_SHARED;
int GO_MPI_ERR_RMA_SYNC = MPI_ERR_RMA_SYNC;
int GO_MPI_ERR_ROOT = MPI_ERR_ROOT;
int GO_MPI_ERR_SERVICE = MPI_ERR_SERVICE;
int GO_MPI_ERR_SIZE = MPI_ERR_SIZE;
int GO_MPI_ERR_SPAWN = MPI_ERR_SPAWN;
int GO_MPI_ERR_TAG = MPI_ERR_TAG;
int GO_MPI_ERR_TOPOLOGY = MPI_ERR_TOPOLOGY;
int GO_MPI_ERR_TRUNCATE = MPI_ERR_TRUNCATE;
int GO_MPI_ERR_TYPE = MPI_ERR_TYPE;
int GO_MPI_ERR_UNKNOWN = MPI_ERR_UNKNOWN;
int GO_MPI_ERR_UNSUPPORTED_DATAREP = MPI_ERR_UNSUPPORTED_DATAREP;
int GO_MPI_ERR_UNSUPPORTED_OPERATION = MPI_ERR_UNSUPPORTED_OPERATION;
int GO_MPI_ERR_WIN = MPI_ERR_WIN;
MPI_File GO_MPI_FILE_NULL = MPI_FILE_NULL;
MPI_Datatype GO_MPI_FLOAT = MPI_FLOAT;
MPI_Datatype GO_MPI_FLOAT_INT = MPI_FLOAT_INT;
MPI_Group GO_MPI_GROUP_EMPTY = MPI_GROUP_EMPTY;
MPI_Group GO_MPI_GROUP_NULL = MPI_GROUP_NULL;
int GO_MPI_HOST = MPI_HOST;
int GO_MPI_IDENT = MPI_IDENT;
MPI_Info GO_MPI_INFO_ENV = MPI_INFO_ENV;
MPI_Info GO_MPI_INFO_NULL = MPI_INFO_NULL;
MPI_Datatype GO_MPI_INT = MPI_INT;
MPI_Datatype GO_MPI_INT16_T = MPI_INT16_T;
MPI_Datatype GO_MPI_INT32_T = MPI_INT32_T;
MPI_Datatype GO_MPI_INT64_T = MPI_INT64_T;
MPI_Datatype GO_MPI_INT8_T = MPI_INT8_T;
MPI_Datatype GO_MPI_INTEGER = MPI_INTEGER;
MPI_Datatype GO_MPI_INTEGER1 = MPI_INTEGER1;
MPI_Datatype GO_MPI_INTEGER16 = MPI_INTEGER16;
MPI_Datatype GO_MPI_INTEGER2 = MPI_INTEGER2;
MPI_Datatype GO_MPI_INTEGER4 = MPI_INTEGER4;
MPI_Datatype GO_MPI_INTEGER8 = MPI_INTEGER8;
void* GO_MPI_IN_PLACE = MPI_IN_PLACE;
int GO_MPI_IO = MPI_IO;
int GO_MPI_KEYVAL_INVALID = MPI_KEYVAL_INVALID;
MPI_Op GO_MPI_LAND = MPI_LAND;
int GO_MPI_LASTUSEDCODE = MPI_LASTUSEDCODE;
MPI_Datatype GO_MPI_LB = MPI_LB;
int GO_MPI_LOCK_EXCLUSIVE = MPI_LOCK_EXCLUSIVE;
int GO_MPI_LOCK_SHARED = MPI_LOCK_SHARED;
MPI_Datatype GO_MPI_LOGICAL = MPI_LOGICAL;
MPI_Datatype GO_MPI_LONG = MPI_LONG;
MPI_Datatype GO_MPI_LONG_DOUBLE = MPI_LONG_DOUBLE;
MPI_Datatype GO_MPI_LONG_DOUBLE_INT = MPI_LONG_DOUBLE_INT;
MPI_Datatype GO_MPI_LONG_INT = MPI_LONG_INT;
int GO_MPI_LONG_LONG = MPI_LONG_LONG;
MPI_Datatype GO_MPI_LONG_LONG_INT = MPI_LONG_LONG_INT;
MPI_Op GO_MPI_LOR = MPI_LOR;
MPI_Op GO_MPI_LXOR = MPI_LXOR;
MPI_Op GO_MPI_MAX = MPI_MAX;
MPI_Op GO_MPI_MAXLOC = MPI_MAXLOC;
int GO_MPI_MAX_DATAREP_STRING = MPI_MAX_DATAREP_STRING;
int GO_MPI_MAX_ERROR_STRING = MPI_MAX_ERROR_STRING;
int GO_MPI_MAX_INFO_KEY = MPI_MAX_INFO_KEY;
int GO_MPI_MAX_INFO_VAL = MPI_MAX_INFO_VAL;
int GO_MPI_MAX_LIBRARY_VERSION_STRING = MPI_MAX_LIBRARY_VERSION_STRING;
int GO_MPI_MAX_OBJECT_NAME = MPI_MAX_OBJECT_NAME;
int GO_MPI_MAX_PORT_NAME = MPI_MAX_PORT_NAME;
int GO_MPI_MAX_PROCESSOR_NAME = MPI_MAX_PROCESSOR_NAME;
MPI_Message GO_MPI_MESSAGE_NO_PROC = MPI_MESSAGE_NO_PROC;
MPI_Message GO_MPI_MESSAGE_NULL = MPI_MESSAGE_NULL;
MPI_Op GO_MPI_MIN = MPI_MIN;
MPI_Op GO_MPI_MINLOC = MPI_MINLOC;
int GO_MPI_MODE_APPEND = MPI_MODE_APPEND;
int GO_MPI_MODE_CREATE = MPI_MODE_CREATE;
int GO_MPI_MODE_DELETE_ON_CLOSE = MPI_MODE_DELETE_ON_CLOSE;
int GO_MPI_MODE_EXCL = MPI_MODE_EXCL;
int GO_MPI_MODE_NOCHECK = MPI_MODE_NOCHECK;
int GO_MPI_MODE_NOPRECEDE = MPI_MODE_NOPRECEDE;
int GO_MPI_MODE_NOPUT = MPI_MODE_NOPUT;
int GO_MPI_MODE_NOSTORE = MPI_MODE_NOSTORE;
int GO_MPI_MODE_NOSUCCEED = MPI_MODE_NOSUCCEED;
int GO_MPI_MODE_RDONLY = MPI_MODE_RDONLY;
int GO_MPI_MODE_RDWR = MPI_MODE_RDWR;
int GO_MPI_MODE_SEQUENTIAL = MPI_MODE_SEQUENTIAL;
int GO_MPI_MODE_UNIQUE_OPEN = MPI_MODE_UNIQUE_OPEN;
int GO_MPI_MODE_WRONLY = MPI_MODE_WRONLY;
MPI_Op GO_MPI_NO_OP = MPI_NO_OP;
MPI_Copy_function * GO_MPI_NULL_COPY_FN = MPI_NULL_COPY_FN;
MPI_Delete_function * GO_MPI_NULL_DELETE_FN = MPI_NULL_DELETE_FN;
MPI_Datatype GO_MPI_OFFSET = MPI_OFFSET;
MPI_Op GO_MPI_OP_NULL = MPI_OP_NULL;
int GO_MPI_ORDER_C = MPI_ORDER_C;
int GO_MPI_ORDER_FORTRAN = MPI_ORDER_FORTRAN;
MPI_Datatype GO_MPI_PACKED = MPI_PACKED;
int GO_MPI_PROC_NULL = MPI_PROC_NULL;
MPI_Op GO_MPI_PROD = MPI_PROD;
MPI_Datatype GO_MPI_REAL = MPI_REAL;
MPI_Datatype GO_MPI_REAL16 = MPI_REAL16;
MPI_Datatype GO_MPI_REAL4 = MPI_REAL4;
MPI_Datatype GO_MPI_REAL8 = MPI_REAL8;
MPI_Op GO_MPI_REPLACE = MPI_REPLACE;
MPI_Request GO_MPI_REQUEST_NULL = MPI_REQUEST_NULL;
int GO_MPI_ROOT = MPI_ROOT;
int GO_MPI_SEEK_CUR = MPI_SEEK_CUR;
int GO_MPI_SEEK_END = MPI_SEEK_END;
int GO_MPI_SEEK_SET = MPI_SEEK_SET;
MPI_Datatype GO_MPI_SHORT = MPI_SHORT;
MPI_Datatype GO_MPI_SHORT_INT = MPI_SHORT_INT;
MPI_Datatype GO_MPI_SIGNED_CHAR = MPI_SIGNED_CHAR;
int GO_MPI_SIMILAR = MPI_SIMILAR;
MPI_Status * GO_MPI_STATUSES_IGNORE = MPI_STATUSES_IGNORE;
MPI_Status * GO_MPI_STATUS_IGNORE = MPI_STATUS_IGNORE;
int GO_MPI_SUBVERSION = MPI_SUBVERSION;
int GO_MPI_SUCCESS = MPI_SUCCESS;
MPI_Op GO_MPI_SUM = MPI_SUM;
int GO_MPI_TAG_UB = MPI_TAG_UB;
int GO_MPI_THREAD_FUNNELED = MPI_THREAD_FUNNELED;
int GO_MPI_THREAD_MULTIPLE = MPI_THREAD_MULTIPLE;
int GO_MPI_THREAD_SERIALIZED = MPI_THREAD_SERIALIZED;
int GO_MPI_THREAD_SINGLE = MPI_THREAD_SINGLE;
int GO_MPI_TYPECLASS_COMPLEX = MPI_TYPECLASS_COMPLEX;
int GO_MPI_TYPECLASS_INTEGER = MPI_TYPECLASS_INTEGER;
int GO_MPI_TYPECLASS_REAL = MPI_TYPECLASS_REAL;
MPI_Type_copy_attr_function* GO_MPI_TYPE_DUP_FN = MPI_TYPE_DUP_FN;
MPI_Type_copy_attr_function* GO_MPI_TYPE_NULL_COPY_FN = MPI_TYPE_NULL_COPY_FN;
MPI_Type_delete_attr_function* GO_MPI_TYPE_NULL_DELETE_FN = MPI_TYPE_NULL_DELETE_FN;
MPI_T_cvar_handle GO_MPI_T_CVAR_HANDLE_NULL = MPI_T_CVAR_HANDLE_NULL;
MPI_T_enum GO_MPI_T_ENUM_NULL = MPI_T_ENUM_NULL;
int GO_MPI_T_ERR_CANNOT_INIT = MPI_T_ERR_CANNOT_INIT;
int GO_MPI_T_ERR_CVAR_SET_NEVER = MPI_T_ERR_CVAR_SET_NEVER;
int GO_MPI_T_ERR_CVAR_SET_NOT_NOW = MPI_T_ERR_CVAR_SET_NOT_NOW;
int GO_MPI_T_ERR_INVALID = MPI_T_ERR_INVALID;
int GO_MPI_T_ERR_INVALID_HANDLE = MPI_T_ERR_INVALID_HANDLE;
int GO_MPI_T_ERR_INVALID_INDEX = MPI_T_ERR_INVALID_INDEX;
int GO_MPI_T_ERR_INVALID_ITEM = MPI_T_ERR_INVALID_ITEM;
int GO_MPI_T_ERR_INVALID_NAME = MPI_T_ERR_INVALID_NAME;
int GO_MPI_T_ERR_INVALID_SESSION = MPI_T_ERR_INVALID_SESSION;
int GO_MPI_T_ERR_MEMORY = MPI_T_ERR_MEMORY;
int GO_MPI_T_ERR_NOT_INITIALIZED = MPI_T_ERR_NOT_INITIALIZED;
int GO_MPI_T_ERR_OUT_OF_HANDLES = MPI_T_ERR_OUT_OF_HANDLES;
int GO_MPI_T_ERR_OUT_OF_SESSIONS = MPI_T_ERR_OUT_OF_SESSIONS;
int GO_MPI_T_ERR_PVAR_NO_ATOMIC = MPI_T_ERR_PVAR_NO_ATOMIC;
int GO_MPI_T_ERR_PVAR_NO_STARTSTOP = MPI_T_ERR_PVAR_NO_STARTSTOP;
int GO_MPI_T_ERR_PVAR_NO_WRITE = MPI_T_ERR_PVAR_NO_WRITE;
MPI_T_pvar_handle GO_MPI_T_PVAR_HANDLE_NULL = MPI_T_PVAR_HANDLE_NULL;
MPI_T_pvar_session GO_MPI_T_PVAR_SESSION_NULL = MPI_T_PVAR_SESSION_NULL;
MPI_Datatype GO_MPI_UB = MPI_UB;
MPI_Datatype GO_MPI_UINT16_T = MPI_UINT16_T;
MPI_Datatype GO_MPI_UINT32_T = MPI_UINT32_T;
MPI_Datatype GO_MPI_UINT64_T = MPI_UINT64_T;
MPI_Datatype GO_MPI_UINT8_T = MPI_UINT8_T;
int GO_MPI_UNDEFINED = MPI_UNDEFINED;
int GO_MPI_UNEQUAL = MPI_UNEQUAL;
int GO_MPI_UNIVERSE_SIZE = MPI_UNIVERSE_SIZE;
MPI_Datatype GO_MPI_UNSIGNED = MPI_UNSIGNED;
MPI_Datatype GO_MPI_UNSIGNED_CHAR = MPI_UNSIGNED_CHAR;
MPI_Datatype GO_MPI_UNSIGNED_LONG = MPI_UNSIGNED_LONG;
MPI_Datatype GO_MPI_UNSIGNED_LONG_LONG = MPI_UNSIGNED_LONG_LONG;
MPI_Datatype GO_MPI_UNSIGNED_SHORT = MPI_UNSIGNED_SHORT;
int GO_MPI_VERSION = MPI_VERSION;
MPI_Datatype GO_MPI_WCHAR = MPI_WCHAR;
int GO_MPI_WIN_BASE = MPI_WIN_BASE;
int GO_MPI_WIN_CREATE_FLAVOR = MPI_WIN_CREATE_FLAVOR;
int GO_MPI_WIN_DISP_UNIT = MPI_WIN_DISP_UNIT;
MPI_Win_copy_attr_function* GO_MPI_WIN_DUP_FN = MPI_WIN_DUP_FN;
int GO_MPI_WIN_MODEL = MPI_WIN_MODEL;
MPI_Win GO_MPI_WIN_NULL = MPI_WIN_NULL;
MPI_Win_copy_attr_function* GO_MPI_WIN_NULL_COPY_FN = MPI_WIN_NULL_COPY_FN;
MPI_Win_delete_attr_function* GO_MPI_WIN_NULL_DELETE_FN = MPI_WIN_NULL_DELETE_FN;
int GO_MPI_WIN_SIZE = MPI_WIN_SIZE;
int GO_MPI_WTIME_IS_GLOBAL = MPI_WTIME_IS_GLOBAL;
int Go_MPI_Pcontrol(const int level){return MPI_Pcontrol(level);}
*/
import "C"
import "unsafe"
import "strings"
...
var MPI_2DOUBLE_PRECISION C_MPI_Datatype = C.GO_MPI_2DOUBLE_PRECISION
var MPI_2INT C_MPI_Datatype = C.GO_MPI_2INT
var MPI_2INTEGER C_MPI_Datatype = C.GO_MPI_2INTEGER
var MPI_2REAL C_MPI_Datatype = C.GO_MPI_2REAL
var MPI_AINT C_MPI_Datatype = C.GO_MPI_AINT
var MPI_AINT_FMT_DEC_SPEC [4]C_char = C.GO_MPI_AINT_FMT_DEC_SPEC
var MPI_AINT_FMT_HEX_SPEC [4]C_char = C.GO_MPI_AINT_FMT_HEX_SPEC
var MPI_ANY_SOURCE C_int = C.GO_MPI_ANY_SOURCE
var MPI_ANY_TAG C_int = C.GO_MPI_ANY_TAG
var MPI_APPNUM C_int = C.GO_MPI_APPNUM
var MPI_ARGVS_NULL ***C_char = C.GO_MPI_ARGVS_NULL
var MPI_ARGV_NULL **C_char = C.GO_MPI_ARGV_NULL
var MPI_BAND C_MPI_Op = C.GO_MPI_BAND
var MPI_BOR C_MPI_Op = C.GO_MPI_BOR
var MPI_BOTTOM unsafe.Pointer = C.GO_MPI_BOTTOM
var MPI_BSEND_OVERHEAD C_int = C.GO_MPI_BSEND_OVERHEAD
var MPI_BXOR C_MPI_Op = C.GO_MPI_BXOR
var MPI_BYTE C_MPI_Datatype = C.GO_MPI_BYTE
var MPI_CHAR C_MPI_Datatype = C.GO_MPI_CHAR
var MPI_CHARACTER C_MPI_Datatype = C.GO_MPI_CHARACTER
var MPI_COMM_DUP_FN *C_MPI_Comm_copy_attr_function = C.GO_MPI_COMM_DUP_FN
var MPI_COMM_NULL C_MPI_Comm = C.GO_MPI_COMM_NULL
var MPI_COMM_NULL_COPY_FN *C_MPI_Comm_copy_attr_function = C.GO_MPI_COMM_NULL_COPY_FN
var MPI_COMM_NULL_DELETE_FN *C_MPI_Comm_delete_attr_function = C.GO_MPI_COMM_NULL_DELETE_FN
var MPI_COMM_SELF C_MPI_Comm = C.GO_MPI_COMM_SELF
var MPI_COMM_TYPE_SHARED C_int = C.GO_MPI_COMM_TYPE_SHARED
var MPI_COMM_WORLD C_MPI_Comm = C.GO_MPI_COMM_WORLD
var MPI_COMPLEX C_MPI_Datatype = C.GO_MPI_COMPLEX
var MPI_COMPLEX16 C_MPI_Datatype = C.GO_MPI_COMPLEX16
var MPI_COMPLEX32 C_MPI_Datatype = C.GO_MPI_COMPLEX32
var MPI_COMPLEX8 C_MPI_Datatype = C.GO_MPI_COMPLEX8
var MPI_CONGRUENT C_int = C.GO_MPI_CONGRUENT
var MPI_CONVERSION_FN_NULL *C_MPI_Datarep_conversion_function = C.GO_MPI_CONVERSION_FN_NULL
var MPI_COUNT C_MPI_Datatype = C.GO_MPI_COUNT
var MPI_CXX_BOOL C_MPI_Datatype = C.GO_MPI_CXX_BOOL
var MPI_CXX_DOUBLE_COMPLEX C_MPI_Datatype = C.GO_MPI_CXX_DOUBLE_COMPLEX
var MPI_CXX_FLOAT_COMPLEX C_MPI_Datatype = C.GO_MPI_CXX_FLOAT_COMPLEX
var MPI_CXX_LONG_DOUBLE_COMPLEX C_MPI_Datatype = C.GO_MPI_CXX_LONG_DOUBLE_COMPLEX
var MPI_C_BOOL C_MPI_Datatype = C.GO_MPI_C_BOOL
var MPI_C_COMPLEX C_int = C.GO_MPI_C_COMPLEX
var MPI_C_DOUBLE_COMPLEX C_MPI_Datatype = C.GO_MPI_C_DOUBLE_COMPLEX
var MPI_C_FLOAT_COMPLEX C_MPI_Datatype = C.GO_MPI_C_FLOAT_COMPLEX
var MPI_C_LONG_DOUBLE_COMPLEX C_MPI_Datatype = C.GO_MPI_C_LONG_DOUBLE_COMPLEX
var MPI_DATATYPE_NULL C_MPI_Datatype = C.GO_MPI_DATATYPE_NULL
var MPI_DISPLACEMENT_CURRENT C_int = C.GO_MPI_DISPLACEMENT_CURRENT
var MPI_DISTRIBUTE_BLOCK C_int = C.GO_MPI_DISTRIBUTE_BLOCK
var MPI_DISTRIBUTE_CYCLIC C_int = C.GO_MPI_DISTRIBUTE_CYCLIC
var MPI_DISTRIBUTE_DFLT_DARG C_int = C.GO_MPI_DISTRIBUTE_DFLT_DARG
var MPI_DISTRIBUTE_NONE C_int = C.GO_MPI_DISTRIBUTE_NONE
var MPI_DOUBLE C_MPI_Datatype = C.GO_MPI_DOUBLE
var MPI_DOUBLE_COMPLEX C_MPI_Datatype = C.GO_MPI_DOUBLE_COMPLEX
var MPI_DOUBLE_INT C_MPI_Datatype = C.GO_MPI_DOUBLE_INT
var MPI_DOUBLE_PRECISION C_MPI_Datatype = C.GO_MPI_DOUBLE_PRECISION
var MPI_DUP_FN *[0]byte = C.GO_MPI_DUP_FN
var MPI_ERRCODES_IGNORE *C_int = C.GO_MPI_ERRCODES_IGNORE
var MPI_ERRHANDLER_NULL C_MPI_Errhandler = C.GO_MPI_ERRHANDLER_NULL
var MPI_ERRORS_ARE_FATAL C_MPI_Errhandler = C.GO_MPI_ERRORS_ARE_FATAL
var MPI_ERRORS_RETURN C_MPI_Errhandler = C.GO_MPI_ERRORS_RETURN
var MPI_ERR_ACCESS C_int = C.GO_MPI_ERR_ACCESS
var MPI_ERR_AMODE C_int = C.GO_MPI_ERR_AMODE
var MPI_ERR_ARG C_int = C.GO_MPI_ERR_ARG
var MPI_ERR_ASSERT C_int = C.GO_MPI_ERR_ASSERT
var MPI_ERR_BAD_FILE C_int = C.GO_MPI_ERR_BAD_FILE
var MPI_ERR_BASE C_int = C.GO_MPI_ERR_BASE
var MPI_ERR_BUFFER C_int = C.GO_MPI_ERR_BUFFER
var MPI_ERR_COMM C_int = C.GO_MPI_ERR_COMM
var MPI_ERR_CONVERSION C_int = C.GO_MPI_ERR_CONVERSION
var MPI_ERR_COUNT C_int = C.GO_MPI_ERR_COUNT
var MPI_ERR_DIMS C_int = C.GO_MPI_ERR_DIMS
var MPI_ERR_DISP C_int = C.GO_MPI_ERR_DISP
var MPI_ERR_DUP_DATAREP C_int = C.GO_MPI_ERR_DUP_DATAREP
var MPI_ERR_FILE C_int = C.GO_MPI_ERR_FILE
var MPI_ERR_FILE_EXISTS C_int = C.GO_MPI_ERR_FILE_EXISTS
var MPI_ERR_FILE_IN_USE C_int = C.GO_MPI_ERR_FILE_IN_USE
var MPI_ERR_GROUP C_int = C.GO_MPI_ERR_GROUP
var MPI_ERR_INFO C_int = C.GO_MPI_ERR_INFO
var MPI_ERR_INFO_KEY C_int = C.GO_MPI_ERR_INFO_KEY
var MPI_ERR_INFO_NOKEY C_int = C.GO_MPI_ERR_INFO_NOKEY
var MPI_ERR_INFO_VALUE C_int = C.GO_MPI_ERR_INFO_VALUE
var MPI_ERR_INTERN C_int = C.GO_MPI_ERR_INTERN
var MPI_ERR_IN_STATUS C_int = C.GO_MPI_ERR_IN_STATUS
var MPI_ERR_IO C_int = C.GO_MPI_ERR_IO
var MPI_ERR_KEYVAL C_int = C.GO_MPI_ERR_KEYVAL
var MPI_ERR_LASTCODE C_int = C.GO_MPI_ERR_LASTCODE
var MPI_ERR_LOCKTYPE C_int = C.GO_MPI_ERR_LOCKTYPE
var MPI_ERR_NAME C_int = C.GO_MPI_ERR_NAME
var MPI_ERR_NOT_SAME C_int = C.GO_MPI_ERR_NOT_SAME
var MPI_ERR_NO_MEM C_int = C.GO_MPI_ERR_NO_MEM
var MPI_ERR_NO_SPACE C_int = C.GO_MPI_ERR_NO_SPACE
var MPI_ERR_NO_SUCH_FILE C_int = C.GO_MPI_ERR_NO_SUCH_FILE
var MPI_ERR_OP C_int = C.GO_MPI_ERR_OP
var MPI_ERR_OTHER C_int = C.GO_MPI_ERR_OTHER
var MPI_ERR_PENDING C_int = C.GO_MPI_ERR_PENDING
var MPI_ERR_PORT C_int = C.GO_MPI_ERR_PORT
var MPI_ERR_QUOTA C_int = C.GO_MPI_ERR_QUOTA
var MPI_ERR_RANK C_int = C.GO_MPI_ERR_RANK
var MPI_ERR_READ_ONLY C_int = C.GO_MPI_ERR_READ_ONLY
var MPI_ERR_REQUEST C_int = C.GO_MPI_ERR_REQUEST
var MPI_ERR_RMA_ATTACH C_int = C.GO_MPI_ERR_RMA_ATTACH
var MPI_ERR_RMA_CONFLICT C_int = C.GO_MPI_ERR_RMA_CONFLICT
var MPI_ERR_RMA_FLAVOR C_int = C.GO_MPI_ERR_RMA_FLAVOR
var MPI_ERR_RMA_RANGE C_int = C.GO_MPI_ERR_RMA_RANGE
var MPI_ERR_RMA_SHARED C_int = C.GO_MPI_ERR_RMA_SHARED
var MPI_ERR_RMA_SYNC C_int = C.GO_MPI_ERR_RMA_SYNC
var MPI_ERR_ROOT C_int = C.GO_MPI_ERR_ROOT
var MPI_ERR_SERVICE C_int = C.GO_MPI_ERR_SERVICE
var MPI_ERR_SIZE C_int = C.GO_MPI_ERR_SIZE
var MPI_ERR_SPAWN C_int = C.GO_MPI_ERR_SPAWN
var MPI_ERR_TAG C_int = C.GO_MPI_ERR_TAG
var MPI_ERR_TOPOLOGY C_int = C.GO_MPI_ERR_TOPOLOGY
var MPI_ERR_TRUNCATE C_int = C.GO_MPI_ERR_TRUNCATE
var MPI_ERR_TYPE C_int = C.GO_MPI_ERR_TYPE
var MPI_ERR_UNKNOWN C_int = C.GO_MPI_ERR_UNKNOWN
var MPI_ERR_UNSUPPORTED_DATAREP C_int = C.GO_MPI_ERR_UNSUPPORTED_DATAREP
var MPI_ERR_UNSUPPORTED_OPERATION C_int = C.GO_MPI_ERR_UNSUPPORTED_OPERATION
var MPI_ERR_WIN C_int = C.GO_MPI_ERR_WIN
var MPI_FILE_NULL C_MPI_File = C.GO_MPI_FILE_NULL
var MPI_FLOAT C_MPI_Datatype = C.GO_MPI_FLOAT
var MPI_FLOAT_INT C_MPI_Datatype = C.GO_MPI_FLOAT_INT
var MPI_GROUP_EMPTY C_MPI_Group = C.GO_MPI_GROUP_EMPTY
var MPI_GROUP_NULL C_MPI_Group = C.GO_MPI_GROUP_NULL
var MPI_HOST C_int = C.GO_MPI_HOST
var MPI_IDENT C_int = C.GO_MPI_IDENT
var MPI_INFO_ENV C_MPI_Info = C.GO_MPI_INFO_ENV
var MPI_INFO_NULL C_MPI_Info = C.GO_MPI_INFO_NULL
var MPI_INT C_MPI_Datatype = C.GO_MPI_INT
var MPI_INT16_T C_MPI_Datatype = C.GO_MPI_INT16_T
var MPI_INT32_T C_MPI_Datatype = C.GO_MPI_INT32_T
var MPI_INT64_T C_MPI_Datatype = C.GO_MPI_INT64_T
var MPI_INT8_T C_MPI_Datatype = C.GO_MPI_INT8_T
var MPI_INTEGER C_MPI_Datatype = C.GO_MPI_INTEGER
var MPI_INTEGER1 C_MPI_Datatype = C.GO_MPI_INTEGER1
var MPI_INTEGER16 C_MPI_Datatype = C.GO_MPI_INTEGER16
var MPI_INTEGER2 C_MPI_Datatype = C.GO_MPI_INTEGER2
var MPI_INTEGER4 C_MPI_Datatype = C.GO_MPI_INTEGER4
var MPI_INTEGER8 C_MPI_Datatype = C.GO_MPI_INTEGER8
var MPI_IN_PLACE unsafe.Pointer = C.GO_MPI_IN_PLACE
var MPI_IO C_int = C.GO_MPI_IO
var MPI_KEYVAL_INVALID C_int = C.GO_MPI_KEYVAL_INVALID
var MPI_LAND C_MPI_Op = C.GO_MPI_LAND
var MPI_LASTUSEDCODE C_int = C.GO_MPI_LASTUSEDCODE
var MPI_LB C_MPI_Datatype = C.GO_MPI_LB
var MPI_LOCK_EXCLUSIVE C_int = C.GO_MPI_LOCK_EXCLUSIVE
var MPI_LOCK_SHARED C_int = C.GO_MPI_LOCK_SHARED
var MPI_LOGICAL C_MPI_Datatype = C.GO_MPI_LOGICAL
var MPI_LONG C_MPI_Datatype = C.GO_MPI_LONG
var MPI_LONG_DOUBLE C_MPI_Datatype = C.GO_MPI_LONG_DOUBLE
var MPI_LONG_DOUBLE_INT C_MPI_Datatype = C.GO_MPI_LONG_DOUBLE_INT
var MPI_LONG_INT C_MPI_Datatype = C.GO_MPI_LONG_INT
var MPI_LONG_LONG C_int = C.GO_MPI_LONG_LONG
var MPI_LONG_LONG_INT C_MPI_Datatype = C.GO_MPI_LONG_LONG_INT
var MPI_LOR C_MPI_Op = C.GO_MPI_LOR
var MPI_LXOR C_MPI_Op = C.GO_MPI_LXOR
var MPI_MAX C_MPI_Op = C.GO_MPI_MAX
var MPI_MAXLOC C_MPI_Op = C.GO_MPI_MAXLOC
var MPI_MAX_DATAREP_STRING C_int = C.GO_MPI_MAX_DATAREP_STRING
var MPI_MAX_ERROR_STRING C_int = C.GO_MPI_MAX_ERROR_STRING
var MPI_MAX_INFO_KEY C_int = C.GO_MPI_MAX_INFO_KEY
var MPI_MAX_INFO_VAL C_int = C.GO_MPI_MAX_INFO_VAL
var MPI_MAX_LIBRARY_VERSION_STRING C_int = C.GO_MPI_MAX_LIBRARY_VERSION_STRING
var MPI_MAX_OBJECT_NAME C_int = C.GO_MPI_MAX_OBJECT_NAME
var MPI_MAX_PORT_NAME C_int = C.GO_MPI_MAX_PORT_NAME
var MPI_MAX_PROCESSOR_NAME C_int = C.GO_MPI_MAX_PROCESSOR_NAME
var MPI_MESSAGE_NO_PROC C_MPI_Message = C.GO_MPI_MESSAGE_NO_PROC
var MPI_MESSAGE_NULL C_MPI_Message = C.GO_MPI_MESSAGE_NULL
var MPI_MIN C_MPI_Op = C.GO_MPI_MIN
var MPI_MINLOC C_MPI_Op = C.GO_MPI_MINLOC
var MPI_MODE_APPEND C_int = C.GO_MPI_MODE_APPEND
var MPI_MODE_CREATE C_int = C.GO_MPI_MODE_CREATE
var MPI_MODE_DELETE_ON_CLOSE C_int = C.GO_MPI_MODE_DELETE_ON_CLOSE
var MPI_MODE_EXCL C_int = C.GO_MPI_MODE_EXCL
var MPI_MODE_NOCHECK C_int = C.GO_MPI_MODE_NOCHECK
var MPI_MODE_NOPRECEDE C_int = C.GO_MPI_MODE_NOPRECEDE
var MPI_MODE_NOPUT C_int = C.GO_MPI_MODE_NOPUT
var MPI_MODE_NOSTORE C_int = C.GO_MPI_MODE_NOSTORE
var MPI_MODE_NOSUCCEED C_int = C.GO_MPI_MODE_NOSUCCEED
var MPI_MODE_RDONLY C_int = C.GO_MPI_MODE_RDONLY
var MPI_MODE_RDWR C_int = C.GO_MPI_MODE_RDWR
var MPI_MODE_SEQUENTIAL C_int = C.GO_MPI_MODE_SEQUENTIAL
var MPI_MODE_UNIQUE_OPEN C_int = C.GO_MPI_MODE_UNIQUE_OPEN
var MPI_MODE_WRONLY C_int = C.GO_MPI_MODE_WRONLY
var MPI_NO_OP C_MPI_Op = C.GO_MPI_NO_OP
var MPI_NULL_COPY_FN *C_MPI_Copy_function = C.GO_MPI_NULL_COPY_FN
var MPI_NULL_DELETE_FN *C_MPI_Delete_function = C.GO_MPI_NULL_DELETE_FN
var MPI_OFFSET C_MPI_Datatype = C.GO_MPI_OFFSET
var MPI_OP_NULL C_MPI_Op = C.GO_MPI_OP_NULL
var MPI_ORDER_C C_int = C.GO_MPI_ORDER_C
var MPI_ORDER_FORTRAN C_int = C.GO_MPI_ORDER_FORTRAN
var MPI_PACKED C_MPI_Datatype = C.GO_MPI_PACKED
var MPI_PROC_NULL C_int = C.GO_MPI_PROC_NULL
var MPI_PROD C_MPI_Op = C.GO_MPI_PROD
var MPI_REAL C_MPI_Datatype = C.GO_MPI_REAL
var MPI_REAL16 C_MPI_Datatype = C.GO_MPI_REAL16
var MPI_REAL4 C_MPI_Datatype = C.GO_MPI_REAL4
var MPI_REAL8 C_MPI_Datatype = C.GO_MPI_REAL8
var MPI_REPLACE C_MPI_Op = C.GO_MPI_REPLACE
var MPI_REQUEST_NULL C_MPI_Request = C.GO_MPI_REQUEST_NULL
var MPI_ROOT C_int = C.GO_MPI_ROOT
var MPI_SEEK_CUR C_int = C.GO_MPI_SEEK_CUR
var MPI_SEEK_END C_int = C.GO_MPI_SEEK_END
var MPI_SEEK_SET C_int = C.GO_MPI_SEEK_SET
var MPI_SHORT C_MPI_Datatype = C.GO_MPI_SHORT
var MPI_SHORT_INT C_MPI_Datatype = C.GO_MPI_SHORT_INT
var MPI_SIGNED_CHAR C_MPI_Datatype = C.GO_MPI_SIGNED_CHAR
var MPI_SIMILAR C_int = C.GO_MPI_SIMILAR
var MPI_STATUSES_IGNORE *C_MPI_Status = C.GO_MPI_STATUSES_IGNORE
var MPI_STATUS_IGNORE *C_MPI_Status = C.GO_MPI_STATUS_IGNORE
var MPI_SUBVERSION C_int = C.GO_MPI_SUBVERSION
var MPI_SUCCESS C_int = C.GO_MPI_SUCCESS
var MPI_SUM C_MPI_Op = C.GO_MPI_SUM
var MPI_TAG_UB C_int = C.GO_MPI_TAG_UB
var MPI_THREAD_FUNNELED C_int = C.GO_MPI_THREAD_FUNNELED
var MPI_THREAD_MULTIPLE C_int = C.GO_MPI_THREAD_MULTIPLE
var MPI_THREAD_SERIALIZED C_int = C.GO_MPI_THREAD_SERIALIZED
var MPI_THREAD_SINGLE C_int = C.GO_MPI_THREAD_SINGLE
var MPI_TYPECLASS_COMPLEX C_int = C.GO_MPI_TYPECLASS_COMPLEX
var MPI_TYPECLASS_INTEGER C_int = C.GO_MPI_TYPECLASS_INTEGER
var MPI_TYPECLASS_REAL C_int = C.GO_MPI_TYPECLASS_REAL
var MPI_TYPE_DUP_FN *C_MPI_Type_copy_attr_function = C.GO_MPI_TYPE_DUP_FN
var MPI_TYPE_NULL_COPY_FN *C_MPI_Type_copy_attr_function = C.GO_MPI_TYPE_NULL_COPY_FN
var MPI_TYPE_NULL_DELETE_FN *C_MPI_Type_delete_attr_function = C.GO_MPI_TYPE_NULL_DELETE_FN
var MPI_T_CVAR_HANDLE_NULL C_MPI_T_cvar_handle = C.GO_MPI_T_CVAR_HANDLE_NULL
var MPI_T_ENUM_NULL C_MPI_T_enum = C.GO_MPI_T_ENUM_NULL
var MPI_T_ERR_CANNOT_INIT C_int = C.GO_MPI_T_ERR_CANNOT_INIT
var MPI_T_ERR_CVAR_SET_NEVER C_int = C.GO_MPI_T_ERR_CVAR_SET_NEVER
var MPI_T_ERR_CVAR_SET_NOT_NOW C_int = C.GO_MPI_T_ERR_CVAR_SET_NOT_NOW
var MPI_T_ERR_INVALID C_int = C.GO_MPI_T_ERR_INVALID
var MPI_T_ERR_INVALID_HANDLE C_int = C.GO_MPI_T_ERR_INVALID_HANDLE
var MPI_T_ERR_INVALID_INDEX C_int = C.GO_MPI_T_ERR_INVALID_INDEX
var MPI_T_ERR_INVALID_ITEM C_int = C.GO_MPI_T_ERR_INVALID_ITEM
var MPI_T_ERR_INVALID_NAME C_int = C.GO_MPI_T_ERR_INVALID_NAME
var MPI_T_ERR_INVALID_SESSION C_int = C.GO_MPI_T_ERR_INVALID_SESSION
var MPI_T_ERR_MEMORY C_int = C.GO_MPI_T_ERR_MEMORY
var MPI_T_ERR_NOT_INITIALIZED C_int = C.GO_MPI_T_ERR_NOT_INITIALIZED
var MPI_T_ERR_OUT_OF_HANDLES C_int = C.GO_MPI_T_ERR_OUT_OF_HANDLES
var MPI_T_ERR_OUT_OF_SESSIONS C_int = C.GO_MPI_T_ERR_OUT_OF_SESSIONS
var MPI_T_ERR_PVAR_NO_ATOMIC C_int = C.GO_MPI_T_ERR_PVAR_NO_ATOMIC
var MPI_T_ERR_PVAR_NO_STARTSTOP C_int = C.GO_MPI_T_ERR_PVAR_NO_STARTSTOP
var MPI_T_ERR_PVAR_NO_WRITE C_int = C.GO_MPI_T_ERR_PVAR_NO_WRITE
var MPI_T_PVAR_HANDLE_NULL C_MPI_T_pvar_handle = C.GO_MPI_T_PVAR_HANDLE_NULL
var MPI_T_PVAR_SESSION_NULL C_MPI_T_pvar_session = C.GO_MPI_T_PVAR_SESSION_NULL
var MPI_UB C_MPI_Datatype = C.GO_MPI_UB
var MPI_UINT16_T C_MPI_Datatype = C.GO_MPI_UINT16_T
var MPI_UINT32_T C_MPI_Datatype = C.GO_MPI_UINT32_T
var MPI_UINT64_T C_MPI_Datatype = C.GO_MPI_UINT64_T
var MPI_UINT8_T C_MPI_Datatype = C.GO_MPI_UINT8_T
var MPI_UNDEFINED C_int = C.GO_MPI_UNDEFINED
var MPI_UNEQUAL C_int = C.GO_MPI_UNEQUAL
var MPI_UNIVERSE_SIZE C_int = C.GO_MPI_UNIVERSE_SIZE
var MPI_UNSIGNED C_MPI_Datatype = C.GO_MPI_UNSIGNED
var MPI_UNSIGNED_CHAR C_MPI_Datatype = C.GO_MPI_UNSIGNED_CHAR
var MPI_UNSIGNED_LONG C_MPI_Datatype = C.GO_MPI_UNSIGNED_LONG
var MPI_UNSIGNED_LONG_LONG C_MPI_Datatype = C.GO_MPI_UNSIGNED_LONG_LONG
var MPI_UNSIGNED_SHORT C_MPI_Datatype = C.GO_MPI_UNSIGNED_SHORT
var MPI_VERSION C_int = C.GO_MPI_VERSION
var MPI_WCHAR C_MPI_Datatype = C.GO_MPI_WCHAR
var MPI_WIN_BASE C_int = C.GO_MPI_WIN_BASE
var MPI_WIN_CREATE_FLAVOR C_int = C.GO_MPI_WIN_CREATE_FLAVOR
var MPI_WIN_DISP_UNIT C_int = C.GO_MPI_WIN_DISP_UNIT
var MPI_WIN_DUP_FN *C_MPI_Win_copy_attr_function = C.GO_MPI_WIN_DUP_FN
var MPI_WIN_MODEL C_int = C.GO_MPI_WIN_MODEL
var MPI_WIN_NULL C_MPI_Win = C.GO_MPI_WIN_NULL
var MPI_WIN_NULL_COPY_FN *C_MPI_Win_copy_attr_function = C.GO_MPI_WIN_NULL_COPY_FN
var MPI_WIN_NULL_DELETE_FN *C_MPI_Win_delete_attr_function = C.GO_MPI_WIN_NULL_DELETE_FN
var MPI_WIN_SIZE C_int = C.GO_MPI_WIN_SIZE
var MPI_WTIME_IS_GLOBAL C_int = C.GO_MPI_WTIME_IS_GLOBAL
...
func MPI_Accumulate(origin_addr unsafe.Pointer /*(const void *)*/, origin_count C_int, origin_datatype C_MPI_Datatype, target_rank C_int, target_disp C_MPI_Aint, target_count C_int, target_datatype C_MPI_Datatype, op C_MPI_Op, win C_MPI_Win) error {
...
func MPI_Allgather(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm))
}

func MPI_Allgatherv(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, displs *C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm) error {
...
func MPI_Allreduce(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm))
}

func MPI_Alltoall(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Alltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm))
}

func MPI_Alltoallv(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, sdispls *C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, rdispls *C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Alltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm))
}

func MPI_Alltoallw(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, sdispls *C_int, sendtypes *C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, rdispls *C_int, recvtypes *C_MPI_Datatype, comm C_MPI_Comm) error {
...
func MPI_Bsend(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Bsend(buf, count, datatype, dest, tag, comm))
}

func MPI_Bsend_init(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
...
func MPI_Comm_get_info(comm C_MPI_Comm, info *C_MPI_Info) error {
	return mpi_check(C.MPI_Comm_get_info(comm, info))
}
...
func MPI_Compare_and_swap(origin_addr unsafe.Pointer /*(const void *)*/, compare_addr unsafe.Pointer /*(const void *)*/, result_addr unsafe.Pointer /*(void *)*/, datatype C_MPI_Datatype, target_rank C_int, target_disp C_MPI_Aint, win C_MPI_Win) error {
...
func MPI_Exscan(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Exscan(sendbuf, recvbuf, count, datatype, op, comm))
}

func MPI_Fetch_and_op(origin_addr unsafe.Pointer /*(const void *)*/, result_addr unsafe.Pointer /*(void *)*/, datatype C_MPI_Datatype, target_rank C_int, target_disp C_MPI_Aint, op C_MPI_Op, win C_MPI_Win) error {
...
func MPI_File_iread_at(fh C_MPI_File, offset C_MPI_Offset, buf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, request *C_MPI_Request) error {
...
func MPI_File_iwrite(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, request *C_MPI_Request) error {
	return mpi_check(C.MPI_File_iwrite(fh, buf, count, datatype, request))
}

func MPI_File_iwrite_all(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, request *C_MPI_Request) error {
	return mpi_check(C.MPI_File_iwrite_all(fh, buf, count, datatype, request))
}

func MPI_File_iwrite_at(fh C_MPI_File, offset C_MPI_Offset, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, request *C_MPI_Request) error {
	return mpi_check(C.MPI_File_iwrite_at(fh, offset, buf, count, datatype, request))
}

func MPI_File_iwrite_at_all(fh C_MPI_File, offset C_MPI_Offset, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, request *C_MPI_Request) error {
	return mpi_check(C.MPI_File_iwrite_at_all(fh, offset, buf, count, datatype, request))
}

func MPI_File_iwrite_shared(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, request *C_MPI_Request) error {
...
func MPI_File_write(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, status *C_MPI_Status) error {
	return mpi_check(C.MPI_File_write(fh, buf, count, datatype, status))
}

func MPI_File_write_all(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, status *C_MPI_Status) error {
	return mpi_check(C.MPI_File_write_all(fh, buf, count, datatype, status))
}

func MPI_File_write_all_begin(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype) error {
	return mpi_check(C.MPI_File_write_all_begin(fh, buf, count, datatype))
}

func MPI_File_write_all_end(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, status *C_MPI_Status) error {
	return mpi_check(C.MPI_File_write_all_end(fh, buf, status))
}

func MPI_File_write_at(fh C_MPI_File, offset C_MPI_Offset, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, status *C_MPI_Status) error {
	return mpi_check(C.MPI_File_write_at(fh, offset, buf, count, datatype, status))
}

func MPI_File_write_at_all(fh C_MPI_File, offset C_MPI_Offset, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, status *C_MPI_Status) error {
	return mpi_check(C.MPI_File_write_at_all(fh, offset, buf, count, datatype, status))
}

func MPI_File_write_at_all_begin(fh C_MPI_File, offset C_MPI_Offset, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype) error {
	return mpi_check(C.MPI_File_write_at_all_begin(fh, offset, buf, count, datatype))
}

func MPI_File_write_at_all_end(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, status *C_MPI_Status) error {
	return mpi_check(C.MPI_File_write_at_all_end(fh, buf, status))
}

func MPI_File_write_ordered(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, status *C_MPI_Status) error {
	return mpi_check(C.MPI_File_write_ordered(fh, buf, count, datatype, status))
}

func MPI_File_write_ordered_begin(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype) error {
	return mpi_check(C.MPI_File_write_ordered_begin(fh, buf, count, datatype))
}

func MPI_File_write_ordered_end(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, status *C_MPI_Status) error {
	return mpi_check(C.MPI_File_write_ordered_end(fh, buf, status))
}

func MPI_File_write_shared(fh C_MPI_File, buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, status *C_MPI_Status) error {
...
func MPI_Gather(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, root C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Gather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm))
}

func MPI_Gatherv(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, displs *C_int, recvtype C_MPI_Datatype, root C_int, comm C_MPI_Comm) error {
...
func MPI_Get_accumulate(origin_addr unsafe.Pointer /*(const void *)*/, origin_count C_int, origin_datatype C_MPI_Datatype, result_addr unsafe.Pointer /*(void *)*/, result_count C_int, result_datatype C_MPI_Datatype, target_rank C_int, target_disp C_MPI_Aint, target_count C_int, target_datatype C_MPI_Datatype, op C_MPI_Op, win C_MPI_Win) error {
...
func MPI_Get_address(location unsafe.Pointer /*(const void *)*/, address *C_MPI_Aint) error {
...
func MPI_Group_range_excl(group C_MPI_Group, n C_int, ranges3 *[3]C_int, newgroup *C_MPI_Group) error {
	return mpi_check(C.MPI_Group_range_excl(group, n, ranges3, newgroup))
}

func MPI_Group_range_incl(group C_MPI_Group, n C_int, ranges3 *[3]C_int, newgroup *C_MPI_Group) error {
	return mpi_check(C.MPI_Group_range_incl(group, n, ranges3, newgroup))
}
...
func MPI_Iallgather(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Iallgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request))
}

func MPI_Iallgatherv(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, displs *C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Iallgatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, request))
}

func MPI_Iallreduce(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Iallreduce(sendbuf, recvbuf, count, datatype, op, comm, request))
}

func MPI_Ialltoall(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ialltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request))
}

func MPI_Ialltoallv(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, sdispls *C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, rdispls *C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ialltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm, request))
}

func MPI_Ialltoallw(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, sdispls *C_int, sendtypes *C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, rdispls *C_int, recvtypes *C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
...
func MPI_Ibsend(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ibsend(buf, count, datatype, dest, tag, comm, request))
}

func MPI_Iexscan(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Iexscan(sendbuf, recvbuf, count, datatype, op, comm, request))
}

func MPI_Igather(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, root C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Igather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, request))
}

func MPI_Igatherv(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, displs *C_int, recvtype C_MPI_Datatype, root C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
...
func MPI_Ineighbor_allgather(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ineighbor_allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request))
}

func MPI_Ineighbor_allgatherv(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, displs *C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ineighbor_allgatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, request))
}

func MPI_Ineighbor_alltoall(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ineighbor_alltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request))
}

func MPI_Ineighbor_alltoallv(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, sdispls *C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, rdispls *C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
...
func MPI_Ineighbor_alltoallw(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, sdispls *C_MPI_Aint, sendtypes *C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, rdispls *C_MPI_Aint, recvtypes *C_MPI_Datatype, comm C_MPI_Comm, request *C_MPI_Request) error {
...
func MPI_Ireduce(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op, root C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ireduce(sendbuf, recvbuf, count, datatype, op, root, comm, request))
}

func MPI_Ireduce_scatter(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ireduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op, comm, request))
}

func MPI_Ireduce_scatter_block(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Ireduce_scatter_block(sendbuf, recvbuf, recvcount, datatype, op, comm, request))
}

func MPI_Irsend(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
...
func MPI_Iscan(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Iscan(sendbuf, recvbuf, count, datatype, op, comm, request))
}

func MPI_Iscatter(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, root C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Iscatter(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, request))
}

func MPI_Iscatterv(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, displs *C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, root C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Iscatterv(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm, request))
}

func MPI_Isend(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Isend(buf, count, datatype, dest, tag, comm, request))
}

func MPI_Issend(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
...
func MPI_Neighbor_allgather(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Neighbor_allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm))
}

func MPI_Neighbor_allgatherv(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, displs *C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Neighbor_allgatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm))
}

func MPI_Neighbor_alltoall(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Neighbor_alltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm))
}

func MPI_Neighbor_alltoallv(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, sdispls *C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, rdispls *C_int, recvtype C_MPI_Datatype, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Neighbor_alltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm))
}

func MPI_Neighbor_alltoallw(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, sdispls *C_MPI_Aint, sendtypes *C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, rdispls *C_MPI_Aint, recvtypes *C_MPI_Datatype, comm C_MPI_Comm) error {
...
func MPI_Pack(inbuf unsafe.Pointer /*(const void *)*/, incount C_int, datatype C_MPI_Datatype, outbuf unsafe.Pointer /*(void *)*/, outsize C_int, position *C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Pack(inbuf, incount, datatype, outbuf, outsize, position, comm))
}

func MPI_Pack_external(datarep *C_char, inbuf unsafe.Pointer /*(const void *)*/, incount C_int, datatype C_MPI_Datatype, outbuf unsafe.Pointer /*(void *)*/, outsize C_MPI_Aint, position *C_MPI_Aint) error {
...
func MPI_Pcontrol(level C_int) error {
	return mpi_check(C.Go_MPI_Pcontrol(level))
}
...
func MPI_Put(origin_addr unsafe.Pointer /*(const void *)*/, origin_count C_int, origin_datatype C_MPI_Datatype, target_rank C_int, target_disp C_MPI_Aint, target_count C_int, target_datatype C_MPI_Datatype, win C_MPI_Win) error {
...
func MPI_Raccumulate(origin_addr unsafe.Pointer /*(const void *)*/, origin_count C_int, origin_datatype C_MPI_Datatype, target_rank C_int, target_disp C_MPI_Aint, target_count C_int, target_datatype C_MPI_Datatype, op C_MPI_Op, win C_MPI_Win, request *C_MPI_Request) error {
...
func MPI_Reduce(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op, root C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Reduce(sendbuf, recvbuf, count, datatype, op, root, comm))
}

func MPI_Reduce_local(inbuf unsafe.Pointer /*(const void *)*/, inoutbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op) error {
	return mpi_check(C.MPI_Reduce_local(inbuf, inoutbuf, count, datatype, op))
}

func MPI_Reduce_scatter(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, recvcounts *C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Reduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op, comm))
}

func MPI_Reduce_scatter_block(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm) error {
...
func MPI_Rget_accumulate(origin_addr unsafe.Pointer /*(const void *)*/, origin_count C_int, origin_datatype C_MPI_Datatype, result_addr unsafe.Pointer /*(void *)*/, result_count C_int, result_datatype C_MPI_Datatype, target_rank C_int, target_disp C_MPI_Aint, target_count C_int, target_datatype C_MPI_Datatype, op C_MPI_Op, win C_MPI_Win, request *C_MPI_Request) error {
...
func MPI_Rput(origin_addr unsafe.Pointer /*(const void *)*/, origin_count C_int, origin_datatype C_MPI_Datatype, target_rank C_int, target_disp C_MPI_Aint, target_count C_int, target_datatype C_MPI_Datatype, win C_MPI_Win, request *C_MPI_Request) error {
...
func MPI_Rsend(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Rsend(buf, count, datatype, dest, tag, comm))
}

func MPI_Rsend_init(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Rsend_init(buf, count, datatype, dest, tag, comm, request))
}

func MPI_Scan(sendbuf unsafe.Pointer /*(const void *)*/, recvbuf unsafe.Pointer /*(void *)*/, count C_int, datatype C_MPI_Datatype, op C_MPI_Op, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Scan(sendbuf, recvbuf, count, datatype, op, comm))
}

func MPI_Scatter(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, root C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Scatter(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm))
}

func MPI_Scatterv(sendbuf unsafe.Pointer /*(const void *)*/, sendcounts *C_int, displs *C_int, sendtype C_MPI_Datatype, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, root C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Scatterv(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm))
}

func MPI_Send(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Send(buf, count, datatype, dest, tag, comm))
}

func MPI_Send_init(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
	return mpi_check(C.MPI_Send_init(buf, count, datatype, dest, tag, comm, request))
}

func MPI_Sendrecv(sendbuf unsafe.Pointer /*(const void *)*/, sendcount C_int, sendtype C_MPI_Datatype, dest C_int, sendtag C_int, recvbuf unsafe.Pointer /*(void *)*/, recvcount C_int, recvtype C_MPI_Datatype, source C_int, recvtag C_int, comm C_MPI_Comm, status *C_MPI_Status) error {
...
func MPI_Ssend(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Ssend(buf, count, datatype, dest, tag, comm))
}

func MPI_Ssend_init(buf unsafe.Pointer /*(const void *)*/, count C_int, datatype C_MPI_Datatype, dest C_int, tag C_int, comm C_MPI_Comm, request *C_MPI_Request) error {
...
func MPI_T_category_get_index(name *C_char, cat_index *C_int) error {
	return mpi_check(C.MPI_T_category_get_index(name, cat_index))
}
...
func MPI_T_cvar_get_index(name *C_char, cvar_index *C_int) error {
	return mpi_check(C.MPI_T_cvar_get_index(name, cvar_index))
}
...
func MPI_T_cvar_write(handle C_MPI_T_cvar_handle, buf unsafe.Pointer /*(const void *)*/) error {
...
func MPI_T_pvar_get_index(name *C_char, var_class C_int, pvar_index *C_int) error {
	return mpi_check(C.MPI_T_pvar_get_index(name, var_class, pvar_index))
}
...
func MPI_T_pvar_write(session C_MPI_T_pvar_session, handle C_MPI_T_pvar_handle, buf unsafe.Pointer /*(const void *)*/) error {
...
func MPI_Type_get_true_extent_x(datatype C_MPI_Datatype, lb *C_MPI_Count, extent *C_MPI_Count) error {
	return mpi_check(C.MPI_Type_get_true_extent_x(datatype, lb, extent))
}
...
func MPI_Unpack(inbuf unsafe.Pointer /*(const void *)*/, insize C_int, position *C_int, outbuf unsafe.Pointer /*(void *)*/, outcount C_int, datatype C_MPI_Datatype, comm C_MPI_Comm) error {
	return mpi_check(C.MPI_Unpack(inbuf, insize, position, outbuf, outcount, datatype, comm))
}

func MPI_Unpack_external(datarep *C_char, inbuf unsafe.Pointer /*(const void *)*/, insize C_MPI_Aint, position *C_MPI_Aint, outbuf unsafe.Pointer /*(void *)*/, outcount C_int, datatype C_MPI_Datatype) error {
...
func MPI_Win_detach(win C_MPI_Win, base unsafe.Pointer /*(const void *)*/) error {
