...
func (p *IIOModuleClient) TextFile(ctx context.Context, path string) (_err error) {
  var _args15 IIOModuleTextFileArgs
  _args15.Path = path
  var _result17 IIOModuleTextFileResult
  var _meta16 thrift.ResponseMeta
  _meta16, _err = p.Client_().Call(ctx, "textFile", &_args15, &_result17)
...
func (p *IIOModuleClient) TextFile2(ctx context.Context, path string, minPartitions int64) (_err error) {
  var _args18 IIOModuleTextFile2Args
  _args18.Path = path
  _args18.MinPartitions = minPartitions
  var _result20 IIOModuleTextFile2Result
  var _meta19 thrift.ResponseMeta
  _meta19, _err = p.Client_().Call(ctx, "textFile2", &_args18, &_result20)
...
func (p *IIOModuleClient) PartitionObjectFile(ctx context.Context, path string, first int64, partitions int64) (_err error) {
  var _args21 IIOModulePartitionObjectFileArgs
  _args21.Path = path
  _args21.First = first
  _args21.Partitions = partitions
  var _result23 IIOModulePartitionObjectFileResult
  var _meta22 thrift.ResponseMeta
  _meta22, _err = p.Client_().Call(ctx, "partitionObjectFile", &_args21, &_result23)
...
func (p *IIOModuleClient) PartitionObjectFile4(ctx context.Context, path string, first int64, partitions int64, src *rpc.ISource) (_err error) {
  var _args24 IIOModulePartitionObjectFile4Args
  _args24.Path = path
  _args24.First = first
  _args24.Partitions = partitions
  _args24.Src = src
  var _result26 IIOModulePartitionObjectFile4Result
  var _meta25 thrift.ResponseMeta
  _meta25, _err = p.Client_().Call(ctx, "partitionObjectFile4", &_args24, &_result26)
...
func (p *IIOModuleClient) PartitionTextFile(ctx context.Context, path string, first int64, partitions int64) (_err error) {
  var _args27 IIOModulePartitionTextFileArgs
  _args27.Path = path
  _args27.First = first
  _args27.Partitions = partitions
  var _result29 IIOModulePartitionTextFileResult
  var _meta28 thrift.ResponseMeta
  _meta28, _err = p.Client_().Call(ctx, "partitionTextFile", &_args27, &_result29)
...
func (p *IIOModuleClient) PartitionJsonFile4a(ctx context.Context, path string, first int64, partitions int64, objectMapping bool) (_err error) {
  var _args30 IIOModulePartitionJsonFile4aArgs
  _args30.Path = path
  _args30.First = first
  _args30.Partitions = partitions
  _args30.ObjectMapping = objectMapping
  var _result32 IIOModulePartitionJsonFile4aResult
  var _meta31 thrift.ResponseMeta
  _meta31, _err = p.Client_().Call(ctx, "partitionJsonFile4a", &_args30, &_result32)
...
func (p *IIOModuleClient) PartitionJsonFile4b(ctx context.Context, path string, first int64, partitions int64, src *rpc.ISource) (_err error) {
  var _args33 IIOModulePartitionJsonFile4bArgs
  _args33.Path = path
  _args33.First = first
  _args33.Partitions = partitions
  _args33.Src = src
  var _result35 IIOModulePartitionJsonFile4bResult
  var _meta34 thrift.ResponseMeta
  _meta34, _err = p.Client_().Call(ctx, "partitionJsonFile4b", &_args33, &_result35)
...
func (p *IIOModuleClient) SaveAsObjectFile(ctx context.Context, path string, compression int8, first int64) (_err error) {
  var _args36 IIOModuleSaveAsObjectFileArgs
  _args36.Path = path
  _args36.Compression = compression
  _args36.First = first
  var _result38 IIOModuleSaveAsObjectFileResult
  var _meta37 thrift.ResponseMeta
  _meta37, _err = p.Client_().Call(ctx, "saveAsObjectFile", &_args36, &_result38)
...
func (p *IIOModuleClient) SaveAsTextFile(ctx context.Context, path string, first int64) (_err error) {
  var _args39 IIOModuleSaveAsTextFileArgs
  _args39.Path = path
  _args39.First = first
  var _result41 IIOModuleSaveAsTextFileResult
  var _meta40 thrift.ResponseMeta
  _meta40, _err = p.Client_().Call(ctx, "saveAsTextFile", &_args39, &_result41)
...
func (p *IIOModuleClient) SaveAsJsonFile(ctx context.Context, path string, first int64, pretty bool) (_err error) {
  var _args42 IIOModuleSaveAsJsonFileArgs
  _args42.Path = path
  _args42.First = first
  _args42.Pretty = pretty
  var _result44 IIOModuleSaveAsJsonFileResult
  var _meta43 thrift.ResponseMeta
  _meta43, _err = p.Client_().Call(ctx, "saveAsJsonFile", &_args42, &_result44)
...
func NewIIOModuleProcessor(handler IIOModule) *IIOModuleProcessor {
  ...
  self45 := &IIOModuleProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self45.processorMap["loadClass"] = &iIOModuleProcessorLoadClass{handler:handler}
  self45.processorMap["loadLibrary"] = &iIOModuleProcessorLoadLibrary{handler:handler}
  self45.processorMap["partitionCount"] = &iIOModuleProcessorPartitionCount{handler:handler}
  self45.processorMap["countByPartition"] = &iIOModuleProcessorCountByPartition{handler:handler}
  self45.processorMap["partitionApproxSize"] = &iIOModuleProcessorPartitionApproxSize{handler:handler}
  self45.processorMap["textFile"] = &iIOModuleProcessorTextFile{handler:handler}
  self45.processorMap["textFile2"] = &iIOModuleProcessorTextFile2{handler:handler}
  self45.processorMap["partitionObjectFile"] = &iIOModuleProcessorPartitionObjectFile{handler:handler}
  self45.processorMap["partitionObjectFile4"] = &iIOModuleProcessorPartitionObjectFile4{handler:handler}
  self45.processorMap["partitionTextFile"] = &iIOModuleProcessorPartitionTextFile{handler:handler}
  self45.processorMap["partitionJsonFile4a"] = &iIOModuleProcessorPartitionJsonFile4a{handler:handler}
  self45.processorMap["partitionJsonFile4b"] = &iIOModuleProcessorPartitionJsonFile4b{handler:handler}
  self45.processorMap["saveAsObjectFile"] = &iIOModuleProcessorSaveAsObjectFile{handler:handler}
  self45.processorMap["saveAsTextFile"] = &iIOModuleProcessorSaveAsTextFile{handler:handler}
  self45.processorMap["saveAsJsonFile"] = &iIOModuleProcessorSaveAsJsonFile{handler:handler}
return self45
}
